...
export default function TeamMobile() {
  ...
  const [fadeOut, setFadeOut] = useState(false); // ✅ Added for fade transition
  ...
  return (
    <section className={`team-section ${fadeOut ? "fade-out" : ""}`}>
      {/* 🔷 Glowing logo at top (with smooth fade transition) */}
...
>>>>>>> 2b5298367730bba9316b3a11010cea28720be327
